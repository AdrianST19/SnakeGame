...
//        g.drawString("Game Over",(SCREEN_WIDTH - metrics.stringWidth("Game Over"))/2,SCREEN_HEIGHT/2);
        ...
        g.drawString("Apasa tasta 'Shift' pentru a iesi din joc", 120, 260);
        
        g.setFont(new Font("serif", Font.BOLD, 20));
        g.drawString("Apasa tasta 'Enter' pentru a salva scorul", 120, 290);
    }
         ...
         public void keyPressed(KeyEvent e){
            ...
            switch (e.getKeyCode()){
                ...
                try {
                    ...
                    writer.println("Ultimul scor pe care l-ai obtinut a fost de "+ applesEaten +" puncte");
                    writer.close();
